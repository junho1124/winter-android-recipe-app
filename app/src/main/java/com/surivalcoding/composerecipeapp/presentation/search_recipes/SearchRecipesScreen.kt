...
import com.surivalcoding.composerecipeapp.presentation.search_recipes.component.FilterSearchBottomSheet
...
fun SearchRecipesScreen(
    ...
    Column {
        ...
        Column(
                ...
                LazyVerticalGrid(
                    ...
                    items(
                        ...
                        RecipeCard(
                            ...
                            isBookmarked = state.bookmarkRecipeIds.contains(
                                recipe.id
                            ),
            ...
            println(state.showBottomSheet)
            if (state.showBottomSheet) {
                FilterSearchBottomSheet(
                    onDismissRequest = onDismissBottomSheet,
                    searchFilter = state.searchFilter,
                    categories = state.recipes.map { it.category }.distinct(),
                    onTimeFilterChange = {},
...
private fun SearchRecipesScreenPreview() {
    var state by remember {
        mutableStateOf(
            SearchRecipesScreenState.initialState().copy(
                recipes = List(10) {
                    Recipe.default()
                }
            )
